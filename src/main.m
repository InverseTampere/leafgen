...
tic
Leaves = transform_leaf_cylinders(QSM,LeafCylinderLibrary,TargetLADD,...
                                  ParamFunctions,targetLeafArea);
toc
...
plot_LOD_inc_LCL(QSM,Leaves,LeafCylinderLibrary.LeafDistributions, ...
                 ParamFunctions);
plot_LOD_az_LCL(QSM,Leaves,LeafCylinderLibrary.LeafDistributions, ...
                 ParamFunctions);
plot_LSD_LCL(QSM,Leaves,LeafCylinderLibrary.LeafDistributions, ...
             ParamFunctions);
