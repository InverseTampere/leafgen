...
function f = plot_LOD_inc_CH(aShape,Leaves,varargin)
...
%%  Find the inclination angles of leaves within the given interval
...
% Calculate inclination angles with the arccos of the dot product
incAngles = acos(Leaves.leaf_normal(intervalInds,:)*[0 0 1]');

% Plot histogram
histogram(incAngles,linspace(0,pi/2,nBins+1), ...
